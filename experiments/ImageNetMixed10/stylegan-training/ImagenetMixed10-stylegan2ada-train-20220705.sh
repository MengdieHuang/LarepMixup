...
python tasklauncher-20220702.py run --save_path /root/autodl-tmp/maggie/result --exp_name stylegan2ada-imagenetmixed10 --gen_model stylegan2ada --dataset imagenetmixed10 --data /root/autodl-tmp/maggie/data/imagenetmixed10/imagenetmixed104stylegan2ada/datasets/imagenetmixed10.zip --epochs 1 --batch_size 256 --mode train --train_mode gen-train --gpus 4 --workers 32 --pretrain_pkl_path /root/autodl-tmp/maggie/result/train/gen-train/stylegan2ada-imagenetmixed10/20220704/00000/imagenetmixed10-auto2-batch128-ada-bgc-noresume/network-snapshot-004505.pkl >> /root/autodl-nas/maggie/mmat/log/ImagenetMixed10/stylegan2ada-train/imagenetmixed10-stylegan2ada-train-4gpu-20220705.log 2>&1