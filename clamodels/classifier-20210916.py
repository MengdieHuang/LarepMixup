...
class MaggieClassifier:
    ...
    def __mixuplossfunc__(self,softmax_outputs,batch_labs):
        ...
        alpha_1, w1_label_index = torch.max(batch_labs, 1)                            
        ...
        loss_a = cla_loss(softmax_outputs, w1_label_index)
        loss_b = cla_loss(softmax_outputs, w2_label_index)
