...
class MaggieClassifier:
    ...
    def rmt(self, args,cle_w_train,cle_y_train, raw_x_train, raw_y_train, cle_x_test,cle_y_test, adv_x_test,adv_y_test,exp_result_dir,stylegan2ada_config_kwargs):

        print("cle_w_train.shape:",cle_w_train.shape)   
        print("cle_y_train.shape:",cle_y_train.shape)

        print("raw_x_train.shape:",raw_x_train.shape)   
        print("raw_y_train.shape:",raw_y_train.shape)
        ...
        self._raw_train_tensorset_x = raw_x_train
        self._raw_train_tensorset_y = raw_y_train
