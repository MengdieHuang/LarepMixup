...
python -u tasklauncher-20220814.py run --mode defense --defense_mode inputmixup --beta_alpha 1 --mix_mode basemixup --sample_mode betasampler --attack_mode fgsm --attack_eps 0.02 --blackbox --exp_name preactresnet18-imagenetmixed10 --cla_model preactresnet18 --cla_network_pkl /root/autodl-tmp/maggie/result/train/cla-train/preactresnet18-imagenetmixed10/standard-trained-classifier-preactresnet18-on-clean-imagenetmixed10-epoch-0023-acc-90.47.pkl --dataset imagenetmixed10 --test_adv_dataset /root/autodl-tmp/maggie/result/attack/fgsm/preactresnet18-imagenetmixed10/20220813/00000-testacc-13.93/attack-imagenetmixed10-dataset/samples/test --batch_size 4 --epochs 40 --lr 0.01 >> /root/autodl-nas/maggie/mmat/log/ImagenetMixed10/defense/input-mixup-training/preactresnet18-imagenetmixed10-inputmixup-fgsm-20220814.log 2>&1
