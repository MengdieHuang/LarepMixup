...
# # cifar10 pgd resnet18-acc89.96 eps=0.05 eps_step=0.005 max_iteration=100 
...
# # cifar10 pgd resnet18-acc89.96 eps=0.1 eps_step=0.005 max_iteration=100 
...
# # cifar10 pgd resnet18-acc89.96 eps=0.2 eps_step=0.005 max_iteration=100 
...
# cifar10 pgd resnet18-acc89.96 eps=0.3 eps_step=0.005 max_iteration=100 
...
# cifar10 pgd resnet18-acc89.96 eps=0.03 eps_step=0.005 max_iteration=100 
CUDA_VISIBLE_DEVICES=1 python -u tasklauncher-20230325.py run --mode attack --attack_mode pgd --whitebox --exp_name resnet18-cifar10 --cla_model resnet18 --cla_network_pkl /home/data/maggie/result-newhome/train/cla-train/resnet18-cifar10/20230325/00030-testacc-0.8996/train-cifar10-dataset/standard-trained-classifier-resnet18-on-clean-cifar10-finished.pkl --dataset cifar10 --attack_eps 0.02 --attack_eps_step 0.005 --attack_max_iter 100 >> /home/maggie/mmat/log/CIFAR10/attack-example-generate/pgd/newgen/resnet18-acc89.96-pgd-generate-eps_step0.005-max_iter100-20230325.log 2>&1
