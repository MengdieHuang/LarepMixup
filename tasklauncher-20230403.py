...
if __name__ == '__main__':
    ...
    if args.mode == 'train':
        ...
        if args.defense_mode == "rmt":
            ...
            if args.lr_schedule == 'CosineAnnealingLR':
                print("rmt sgd cosine annel ing !!!!")
                target_classifier.manifoldmixuptrain_sgd_cos(args, cle_x_train, cle_y_train, cle_train_dataloader, cle_x_test,cle_y_test,adv_x_test,adv_y_test,exp_result_dir)
            ...
            if args.lr_schedule == 'CosineAnnealingLR':
                print("rmt sgd cosine annel ing !!!!")
                target_classifier.patchmixuptrain_sgd_cos(args, cle_x_train, cle_y_train, cle_train_dataloader, cle_x_test,cle_y_test,adv_x_test,adv_y_test,exp_result_dir)
