...
with open("cifar10-densenet169-cle-adv-acc-black-fgsm.csv",'r') as f:
...
#---------标题---------
# plt.title(f'Accuracy of DenseNet169 on Black-box Pixel-level Adversarial Attacks',fontsize=12, pad=12)
plt.title(f'DenseNet169 against Black-box Pixel-level Adversarial Attacks',fontsize=12, pad=12)

plt.show()
savepath = f'/home/maggie/mmat/figure/black-fgsm'
savename = f'cifar10-densenet169-cle-adv-acc-black-fgsm-20211104'
