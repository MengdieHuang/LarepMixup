...
with open("cifar10-resnet50-cle-adv-acc-black-fgsm.csv",'r') as f:
...
#---------标题---------
# plt.title(f'Accuracy of ResNet50 on Black-box Pixel-level Adversarial Attacks',fontsize=12, pad=12)
plt.title(f'ResNet50 against Black-box Pixel-level Adversarial Attacks',fontsize=12, pad=12)

plt.show()
savepath = f'/home/maggie/mmat/figure/black-fgsm'
savename = f'cifar10-resnet50-cle-adv-acc-black-fgsm-20211104'
