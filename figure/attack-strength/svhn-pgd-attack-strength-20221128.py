...
with open("svhn-pgd-attack-strengths-20221128.csv",'r') as f:
...
plt.title(f'Improved Accuracy from LarepMixup on SVHN PGD Attacks',fontsize=12, pad=12)
...
savename = f'svhn-pgd-attack-strengths-20221128'
