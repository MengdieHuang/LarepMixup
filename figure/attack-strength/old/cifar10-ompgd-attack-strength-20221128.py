...
with open("cifar10-ompgd-attack-strengths-20221128.csv",'r') as f:
...
plt.title(f'Improved Accuracy from LarepMixup on CIFAR-10 OM-PGD Attacks',fontsize=12, pad=12)
...
savename = f'cifar10-ompgd-attack-strengths-20221128'
