...
with open("cifar10-pgd-attack-strengths-20221128.csv",'r') as f:
...
plt.title(f'Improved Accuracy from LarepMixup on CIFAR-10 PGD Attacks',fontsize=12, pad=12)
...
savename = f'cifar10-pgd-attack-strengths-20221128'
