...
with open("cifar10-pgd-attack-strengths-20230402.csv",'r') as f:
...
savename = f'cifar10-Alexnet-pgd-ompgd-attack-strengths-20230403'
...
plt.title(f'Accuracy of ResNet18 on CIFAR-10 under Different Attack Budgets',fontsize=10, pad=12)
plt.xlabel('Budget',fontsize=10)
plt.ylabel('Top-1 Accuracy',fontsize=10)

plt.show()
savepath = f'/home/maggie/mmat/figure/attack-strength/20230403'
savename = f'cifar10-ResNet18-pgd-attack-strengths-20230403'
plt.savefig(f'{savepath}/{savename}.png')
plt.close()
...
plt.title(f'Accuracy of ResNet34 on CIFAR-10 under Different Attack Budgets',fontsize=10, pad=12)
plt.xlabel('Budget',fontsize=10)
plt.ylabel('Top-1 Accuracy',fontsize=10)

plt.show()
savepath = f'/home/maggie/mmat/figure/attack-strength/20230403'
savename = f'cifar10-ResNet34-pgd-attack-strengths-20230403'
plt.savefig(f'{savepath}/{savename}.png')
plt.close()
...
plt.title(f'Accuracy of ResNet50 on CIFAR-10 under Different Attack Budgets',fontsize=10, pad=12)
plt.xlabel('Budget',fontsize=10)
plt.ylabel('Top-1 Accuracy',fontsize=10)

plt.show()
savepath = f'/home/maggie/mmat/figure/attack-strength/20230403'
savename = f'cifar10-ResNet50-pgd-attack-strengths-20230403'
plt.savefig(f'{savepath}/{savename}.png')
plt.close()
...
plt.title(f'Accuracy of VGG19 on CIFAR-10 under Different Attack Budgets',fontsize=10, pad=12)
plt.xlabel('Budget',fontsize=10)
plt.ylabel('Top-1 Accuracy',fontsize=10)

plt.show()
savepath = f'/home/maggie/mmat/figure/attack-strength/20230403'
savename = f'cifar10-VGG19-pgd-attack-strengths-20230403'
plt.savefig(f'{savepath}/{savename}.png')
plt.close()
...
plt.title(f'Accuracy of DenseNet169 on CIFAR-10 under Different Attack Budgets',fontsize=10, pad=12)
plt.xlabel('Budget',fontsize=10)
plt.ylabel('Top-1 Accuracy',fontsize=10)

plt.show()
savepath = f'/home/maggie/mmat/figure/attack-strength/20230403'
savename = f'cifar10-DenseNet169-pgd-attack-strengths-20230403'
plt.savefig(f'{savepath}/{savename}.png')
plt.close()
...
plt.title(f'Accuracy of GoogleNet on CIFAR-10 under Different Attack Budgets',fontsize=10, pad=12)
plt.xlabel('Budget',fontsize=10)
plt.ylabel('Top-1 Accuracy',fontsize=10)

plt.show()
savepath = f'/home/maggie/mmat/figure/attack-strength/20230403'
savename = f'cifar10-GoogleNet-pgd-attack-strengths-20230403'
plt.savefig(f'{savepath}/{savename}.png')
plt.close()
