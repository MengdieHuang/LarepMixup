...
# 读取数据 convex-adv
with open("cifar10-preactresnet18-whitebox-fgsm-acc-convex-20220223.csv",'r') as f:
...
with open("cifar10-preactresnet34-whitebox-fgsm-acc-convex-20220223.csv",'r') as f:
    data_csv = csv.reader(f)
...
# 读取数据 convex-cle
with open("cifar10-preactresnet18-clean-acc-convex-20220223.csv",'r') as f:
    data_csv = csv.reader(f)
...
with open("cifar10-preactresnet34-clean-acc-convex-20220223.csv",'r') as f:
    data_csv = csv.reader(f)
...
savename = f'cifar10-preactresnet18-preactresnet34-adv-cle-acc-convex-20220223'
