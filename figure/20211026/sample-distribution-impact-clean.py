...
# 读取数据
with open("cifar10-preactresnet18-clean-acc-beta.csv",'r') as f:
...
with open("cifar10-preactresnet18-clean-acc-dirichlet.csv",'r') as f:
    data_csv = csv.reader(f)
...
with open("cifar10-preactresnet34-clean-acc-beta.csv",'r') as f:
    data_csv = csv.reader(f)
...
with open("cifar10-preactresnet34-clean-acc-dirichlet.csv",'r') as f:
    data_csv = csv.reader(f)
...
savename = f'cifar10-preactresnet18-preactresnet34-clean-testset-acc-beta-dirichlet'
