...
with open("cifar10-preactresnet18-clean-acc-dirichlet-20211027.csv",'r') as f:
    data_csv = csv.reader(f)
...
savename = f'cifar10-preactresnet18-preactresnet34-clean-testset-acc-beta-dirichlet-20211027'
