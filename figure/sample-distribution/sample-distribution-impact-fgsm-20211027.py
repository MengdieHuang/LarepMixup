...
with open("cifar10-preactresnet18-whitebox-fgsm-acc-dirichlet-20211027.csv",'r') as f:
    data_csv = csv.reader(f)
...
with open("cifar10-preactresnet34-whitebox-fgsm-acc-dirichlet-20211027.csv",'r') as f:
    data_csv = csv.reader(f)
...
savename = f'cifar10-preactresnet18-preactresnet34-whitebox-fgsm-acc-beta-dirichlet-20211027'
