...
with open("cifar10-vgg19-cle-adv-acc-black-omfgsm.csv",'r') as f:
...
y_major_locator=plt.MultipleLocator(1)       #   把y轴的刻度间隔设置为10，并存在变量里
...
#---------标题---------
# plt.title(f'Accuracy of VGG19 on Black-box Representation-level Adversarial Attacks',fontsize=12, pad=12)
plt.title(f'VGG19 against Black-box Representation-level Adversarial Attacks',fontsize=12, pad=12)

plt.show()
savepath = f'/home/maggie/mmat/figure/black-omfgsm'
savename = f'cifar10-vgg19-cle-adv-acc-black-omfgsm-20211104'
