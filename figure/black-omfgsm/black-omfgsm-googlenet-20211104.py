...
with open("cifar10-googlenet-cle-adv-acc-black-omfgsm.csv",'r') as f:
...
#---------标题---------
# plt.title(f'Accuracy of GoogleNet on Black-box Representation-level Adversarial Attacks',fontsize=12, pad=12)
plt.title(f'GoogleNet against Black-box Representation-level Adversarial Attacks',fontsize=12, pad=12)

plt.show()
savepath = f'/home/maggie/mmat/figure/black-omfgsm'
savename = f'cifar10-googlenet-cle-adv-acc-black-omfgsm-20211104'
