...
plt.plot(step, cur_epoch_cost_time, linestyle='-', color='b')
...
plt.title(f'Each Epoch Cost Time for LarepMixup Training WideResNet28-10',fontsize=10, pad=12)
plt.xlabel('Epoch Index',fontsize=10)
plt.ylabel('Cost Time (seconds)',fontsize=10)

plt.show()
savepath = f'/home/maggie/mmat/figure/costtime'
savename = f'cifar10-wideresnet-rmt-epoch-costtime-20230403'
