...
with open("cifar10-preactresnet18-whitebox-fgsm-acc-dirichlet-20211108.csv",'r') as f:
...
with open("cifar10-preactresnet34-whitebox-fgsm-acc-dirichlet-20211108.csv",'r') as f:
    data_csv = csv.reader(f)
...
with open("cifar10-preactresnet18-clean-acc-dirichlet-20211108.csv",'r') as f:
    data_csv = csv.reader(f)
...
with open("cifar10-preactresnet34-clean-acc-dirichlet-20211108.csv",'r') as f:
    data_csv = csv.reader(f)
...
savename = f'cifar10-preactresnet18-preactresnet34-adv-cle-acc-dirichlet-20211108'
