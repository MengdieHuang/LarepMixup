...
with open("cifar10-preactresnet18-clean-acc-dirichlet-20211029.csv",'r') as f:
    data_csv = csv.reader(f)
...
with open("cifar10-preactresnet34-clean-acc-dirichlet-20211030.csv",'r') as f:
    data_csv = csv.reader(f)
...
plt.grid()
plt.plot(step,preactresnet18_dirichlet_low_adv, label=f'{gamma_str}=({1},{1},{1})', marker='o', markersize=3)
plt.plot(step,preactresnet18_dirichlet_mid_adv, label=f'{gamma_str}=({5},{5},{5})', marker='p', markersize=3)
plt.plot(step,preactresnet18_dirichlet_high_adv, label=f'{gamma_str}=({10},{10},{10})', marker='^', markersize=3)

plt.plot(step,preactresnet34_dirichlet_low_adv, label=f'{gamma_str}=({1},{1},{1})', marker='s', markersize=3)
plt.plot(step,preactresnet34_dirichlet_mid_adv, label=f'{gamma_str}=({5},{5},{5})', marker='D', markersize=3)
plt.plot(step,preactresnet34_dirichlet_high_adv, label=f'{gamma_str}=({10},{10},{10})', marker='*', markersize=3)

plt.legend([f'PreActResNet18 {gamma_str}=({1},{1},{1})',        # gamma=5换成gamma=0.5
...
plt.grid()
plt.plot(step,preactresnet18_dirichlet_low_cle, label=f'{gamma_str}=({1},{1},{1})', marker='o', markersize=3)
plt.plot(step,preactresnet18_dirichlet_mid_cle, label=f'{gamma_str}=({5},{5},{5})', marker='p', markersize=3)
plt.plot(step,preactresnet18_dirichlet_high_cle, label=f'{gamma_str}=({10},{10},{10})', marker='^', markersize=3)

plt.plot(step,preactresnet34_dirichlet_low_cle, label=f'{gamma_str}=({1},{1},{1})', marker='s', markersize=3)
plt.plot(step,preactresnet34_dirichlet_mid_cle, label=f'{gamma_str}=({5},{5},{5})', marker='D', markersize=3)
...
savename = f'cifar10-preactresnet18-preactresnet34-adv-cle-acc-dirichlet-20211101'
