...
# 读取数据-beta分布下的adv准确率
with open("cifar10-preactresnet18-whitebox-fgsm-acc-beta-20211108.csv",'r') as f:
...
with open("cifar10-preactresnet34-whitebox-fgsm-acc-beta-20211108.csv",'r') as f:
    data_csv = csv.reader(f)
...
# 读取数据-beta分布下的cle准确率
with open("cifar10-preactresnet18-clean-acc-beta-20211108.csv",'r') as f:
    data_csv = csv.reader(f)
...
with open("cifar10-preactresnet34-clean-acc-beta-20211108.csv",'r') as f:
    data_csv = csv.reader(f)
...
savename = f'cifar10-preactresnet18-preactresnet34-adv-cle-acc-beta-20211108'
