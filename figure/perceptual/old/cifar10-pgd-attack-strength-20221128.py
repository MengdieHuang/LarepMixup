...
# 读取不同扰动强度下的cifar10 adv准确率
with open("cifar10-perceptual-attack-20221128.csv",'r') as f:
...
# plt.title(f'Accuracy Improvement by LarepMixup on PGD Attacks',fontsize=12, pad=12)
plt.title(f'Improved Accuracy from LarepMixup on CIFAR-10 Perceptual Attacks',fontsize=12, pad=12)

# plt.title(f'Classify White-box FGSM',pad=20)
plt.xlabel('Perceptual Attack',fontsize=10)
...
plt.show()
savepath = f'/home/maggie/mmat/figure/perceptual'
savename = f'cifar10-perceptual-attack-20221128'
