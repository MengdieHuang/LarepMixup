...
# 读取不同模型在不同扰动强度下的svhn PGD准确率
with open("svhn-perceptual-attack-20230402.csv",'r') as f:
...
plt.title(f'Accuracy of AlexNet on SVHN under Different Perceptual Attacks',fontsize=10, pad=12)
...
savename = f'svhn-Alexnet-perceptual-attack-20230403'
...
plt.title(f'Accuracy of ResNet18 on SVHN under Different Perceptual Attacks',fontsize=10, pad=12)
plt.xlabel('Epsilon',fontsize=10)
plt.ylabel('Top-1 Accuracy',fontsize=10)

plt.show()
savepath = f'/home/maggie/mmat/figure/perceptual/202300403'
savename = f'svhn-ResNet18-perceptual-attack-20230403'
plt.savefig(f'{savepath}/{savename}.png')
plt.close()
...
plt.title(f'Accuracy of ResNet34 on SVHN under Different Perceptual Attacks',fontsize=10, pad=12)
plt.xlabel('Epsilon',fontsize=10)
plt.ylabel('Top-1 Accuracy',fontsize=10)

plt.show()
savepath = f'/home/maggie/mmat/figure/perceptual/202300403'
savename = f'svhn-ResNet34-perceptual-attack-20230403'
plt.savefig(f'{savepath}/{savename}.png')
plt.close()
...
plt.title(f'Accuracy of ResNet50 on SVHN under Different Perceptual Attacks',fontsize=10, pad=12)
plt.xlabel('Epsilon',fontsize=10)
plt.ylabel('Top-1 Accuracy',fontsize=10)

plt.show()
savepath = f'/home/maggie/mmat/figure/perceptual/202300403'
savename = f'svhn-ResNet50-perceptual-attack-20230403'
plt.savefig(f'{savepath}/{savename}.png')
plt.close()
...
plt.title(f'Accuracy of VGG19 on SVHN under Different Perceptual Attacks',fontsize=10, pad=12)
plt.xlabel('Epsilon',fontsize=10)
plt.ylabel('Top-1 Accuracy',fontsize=10)

plt.show()
savepath = f'/home/maggie/mmat/figure/perceptual/202300403'
savename = f'svhn-VGG19-perceptual-attack-20230403'
plt.savefig(f'{savepath}/{savename}.png')
plt.close()
...
plt.title(f'Accuracy of DenseNet169 on SVHN under Different Perceptual Attacks',fontsize=10, pad=12)
plt.xlabel('Epsilon',fontsize=10)
plt.ylabel('Top-1 Accuracy',fontsize=10)

plt.show()
savepath = f'/home/maggie/mmat/figure/perceptual/202300403'
savename = f'svhn-DenseNet169-perceptual-attack-20230403'
plt.savefig(f'{savepath}/{savename}.png')
plt.close()
...
plt.title(f'Accuracy of GoogleNet on SVHN under Different Perceptual Attacks',fontsize=10, pad=12)
plt.xlabel('Epsilon',fontsize=10)
plt.ylabel('Top-1 Accuracy',fontsize=10)

plt.show()
savepath = f'/home/maggie/mmat/figure/perceptual/202300403'
savename = f'svhn-GoogleNet-perceptual-attack-20230403'
plt.savefig(f'{savepath}/{savename}.png')
plt.close()
