...
with open("cifar10-preactresnet34-clean-acc-convex-20211029.csv",'r') as f:
    data_csv = csv.reader(f)
...
plt.plot(step,preactresnet34_mask_dual, label=f'convex mixup', marker='s', markersize=3)
plt.plot(step,preactresnet34_mask_ternary, label=f'binary mask mixup', marker='D', markersize=3)
...
savename = f'cifar10-preactresnet18-preactresnet34-clean-acc-convex-mask-20211030'
