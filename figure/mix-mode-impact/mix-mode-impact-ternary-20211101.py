...
with open("cifar10-preactresnet34-whitebox-fgsm-acc-ternary-20211029.csv",'r') as f:
    data_csv = csv.reader(f)
...
with open("cifar10-preactresnet18-clean-acc-ternary-20211028.csv",'r') as f:
    data_csv = csv.reader(f)
...
with open("cifar10-preactresnet34-clean-acc-ternary-20211029.csv",'r') as f:
    data_csv = csv.reader(f)
...
plt.plot(step,preactresnet18_ternary_mask_adv, label=f'binary mask mixup', marker='p', markersize=3)
plt.plot(step,preactresnet34_ternary_convex_adv, label=f'convex mixup', marker='s', markersize=3)
plt.plot(step,preactresnet34_ternary_mask_adv, label=f'binary mask mixup', marker='D', markersize=3)
...
plt.plot(step,preactresnet18_ternary_mask_cle, label=f'binary mask mixup', marker='p', markersize=3)

plt.plot(step,preactresnet34_ternary_convex_cle, label=f'convex mixup', marker='s', markersize=3)
plt.plot(step,preactresnet34_ternary_mask_cle, label=f'binary mask mixup', marker='D', markersize=3)
...
savename = f'cifar10-preactresnet18-preactresnet34-adv-cle-acc-ternary-20211101'
