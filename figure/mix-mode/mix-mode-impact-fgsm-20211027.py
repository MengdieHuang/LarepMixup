...
# 读取数据
with open("cifar10-preactresnet18-whitebox-fgsm-acc-dual-20211027.csv",'r') as f:
...
with open("cifar10-preactresnet18-whitebox-fgsm-acc-ternary-20211027.csv",'r') as f:
    data_csv = csv.reader(f)
...
savename = f'cifar10-preactresnet18-whitebox-fgsm-acc-dual-ternary-20211027'
