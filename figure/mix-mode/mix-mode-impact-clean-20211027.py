...
# 读取数据
with open("cifar10-preactresnet18-clean-acc-dual-20211027.csv",'r') as f:
...
with open("cifar10-preactresnet18-clean-acc-ternary-20211027.csv",'r') as f:
    data_csv = csv.reader(f)
...
savename = f'cifar10-preactresnet18-clean-acc-dual-ternary-20211027'
