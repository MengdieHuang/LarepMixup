...
def open_stl10(tarball: str, *, max_images: Optional[int]):
    ...
    with tarfile.open(tarball, 'r:gz') as tar:                                              #   解压tar.gz
        ...
        # trainset_x_member = tar.getmember(f'stl10_binary/train_X.bin')
        # print("trainset_x_member:",trainset_x_member)                                       #   trainset_x_member: <TarInfo 'stl10_binary/train_X.bin' at 0x7f065a028940>

        # with tar.extractfile(trainset_x_member) as trainset_x_file:
                
        #     # trainset_x_file = tar.extractfile(trainset_x_member)
        #     print("trainset_x_file:",trainset_x_file)                                       #   trainset_x_file: <ExFileObject name='/home/data/maggie/stl10/stl10_binary.tar.gz'>

        #     x_data = pickle.load(trainset_x_file.name,encoding='latin1')        


        trainset_x_bin_file = open('/home/data/maggie/stl10/stl10_binary/train_X.bin','rb')
        x_data = pickle.load(trainset_x_bin_file,encoding='latin1')        
        
        print("x_data.keys(): ",x_data.keys())
        ...
        # with tar.extractfile(trainset_x_member) as trainset_x_file: 
        #     print("trainset_x_file:",trainset_x_file)                                       #   trainset_x_file: <ExFileObject name='/home/data/maggie/stl10/stl10_binary.tar.gz'>
        #     print("trainset_x_file.name:",trainset_x_file.name)                             #   trainset_x_file.name: /home/data/maggie/stl10/stl10_binary.tar.gz
            
        #     trainset_x_bin_file = open(trainset_x_file.name,'rb')
        #     print("trainset_x_bin_file:",trainset_x_bin_file)                               #   trainset_x_bin_file: <_io.BufferedReader name='/home/data/maggie/stl10/stl10_binary.tar.gz'>
        #     print("trainset_x_bin_file.name:",trainset_x_bin_file.name)                     #   trainset_x_bin_file.name: /home/data/maggie/stl10/stl10_binary.tar.gz
            
        #     x_data = pickle.load(trainset_x_bin_file.name,encoding='latin1')        
        
        print("x_data.keys(): ",x_data.keys())

        print(readdata.shape)            
        x_data = pickle.load(file_1, encoding='latin1')

        trainset_y_member = tar.getmember(f'stl10_binary/train_y.bin')
        with tar.extractfile(trainset_y_member) as trainset_y_file:
            y_data = pickle.load(trainset_y_file, encoding='latin1')

        print("x_data.keys(): ",x_data.keys())
        print("y_data.keys() ",y_data.keys())
