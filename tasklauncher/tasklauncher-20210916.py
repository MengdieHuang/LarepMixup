...
if __name__ == '__main__':
    ...
    #-----------------混合训练防御---------------------
        if args.defense_mode == "mmat":
            ...
            #------------混合训练---------
            target_classifier.mmat(args, cle_x_train, cle_y_train, cle_x_test, cle_y_test, x_train_mix, y_train_mix, x_test_adv, y_test_adv, target_classifier.artmodel(), exp_result_dir)   
