...
#-----------------混合训练防御---------------------
    if args.defense_mode == "mmat":
        ...
        print("x_train_mix.shape: ", x_train_mix.shape)                                                             #   x_train_mix.shape:  torch.Size([3, 3, 32, 32])
        print("y_train_mix.type: ", type(y_train_mix))                                                              #   y_train_mix.type:  <class 'torch.Tensor'>
        print("y_train_mix.shape: ", y_train_mix.shape)                                                             #   y_train_mix.shape:  torch.Size([3, 10])
        ...
        print("cle_x_train[0][0]:",cle_x_train[0][0])
        ...
        cle_y_train_onehot = torch.nn.functional.one_hot(cle_y_train, args.n_classes)     
        ...
        print("cle_y_train_onehot.type: ", type(cle_y_train_onehot))                                                #   
        print("cle_y_train_onehot.shape: ", cle_y_train_onehot.shape)                                               #   
        print("cle_y_train_onehot[0]:",cle_y_train_onehot[0])
        ...
        print("aug_x_train[0][0]:",aug_x_train[0][0])
        ...
        # print("aug_x_train.type: ", type(aug_x_train))                                                              #   
        # print("aug_x_train.shape: ", aug_x_train.shape)                                                             #   
        # aug_y_train = np.append(cle_y_train_onehot, y_train_mix, axis=0)
        # print("aug_y_train.type: ", type(aug_y_train))                                                              #   
        # print("aug_y_train.shape: ", aug_y_train.shape)                                                             #   
