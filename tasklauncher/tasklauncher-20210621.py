...
if __name__ == '__main__':
    ...
    # print("cle_train_dataset.data.shape:",cle_train_dataset.data.shape)
    # print("cle_train_dataset.data:",cle_train_dataset.data[:2])
    ...
    #   对抗训练
    cle_x_train = cle_dataloader.traindataloader.dataset.data
    cle_y_train = cle_dataloader.traindataloader.dataset.targets
